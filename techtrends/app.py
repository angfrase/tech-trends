...
# Initiate global variable CONN_COUNT to store the number of connections
CONN_COUNT = 0
...
def post(post_id):
    ...
    if post is None:
        logging.error(f'Article with id {post_id} does not exists')
...
def metrics():
    ...
    data = {"db_connection_count": CONN_COUNT, "post_count": post_count}
